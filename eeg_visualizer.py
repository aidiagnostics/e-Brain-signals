"""
EEG Visualizer is a real-time simulator that allows to
upload an EEG file and "play" it simulating real streaming
-------------------------
...
#        QMainWindow.setWindowTitle('AID')
    ...
    def openF(self):
        ...
        """
        self.file_path, _ = QtWidgets.QFileDialog.getOpenFileName(self, 'Open File')
        # NOTE: 
